...
if __name__ == "__main__":
    ...
    while True:
        ...
        if RED_BOX.isCollision(BLUE_BOX.get_width(), BLUE_BOX.get_height(), BLUE_BOX.getPosition()):
            print("HIT")
            RED_BOX.setScale(0.9)
            BLUE_BOX.setSpeed(12)
            BLUE_BOX.setColor(Color.RED)
            BLUE_BOX.setPosition(randrange(WINDOW.getVirtualWidth()-BLUE_BOX.get_width()), randrange(WINDOW.getVirtualHeight() - BLUE_BOX.get_height()))
            RED_BOX.setPosition(randrange(WINDOW.getVirtualWidth()-RED_BOX.get_width()), randrange(WINDOW.getVirtualHeight() - RED_BOX.get_height()))
